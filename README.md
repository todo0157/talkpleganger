...
### 6. 다중 페르소나 관리
- 7가지 카테고리로 페르소나 분류 (회사/친구/가족/연인/격식체/캐주얼/기타)
- 상황별 빠른 페르소나 전환
- 카테고리 필터로 원하는 페르소나 빠르게 찾기
- 페르소나별 아이콘 및 설명 설정
...
상황에 맞는 페르소나를 빠르게 선택할 수 있습니다.

| 카테고리 | 아이콘 | 용도 |
|---------|-------|------|
| 회사 (work) | 💼 | 직장 동료/상사와 대화 |
| 친구 (friend) | 👋 | 친구와 편하게 대화 |
| 가족 (family) | 🏠 | 부모님/형제와 대화 |
| 연인 (partner) | 💕 | 연인/배우자와 대화 |
| 격식체 (formal) | 🎩 | 공식적인 상황 |
| 캐주얼 (casual) | 😎 | 일상적인 대화 |
| 기타 (other) | 📝 | 그 외 상황 |
