...
- **모바일/PC/iOS 내보내기 형식 모두 지원**
- 상세한 에러 메시지 및 파싱 결과 피드백

**지원 메시지 형식**:
| 플랫폼 | 형식 예시 |
|--------|----------|
| Android/PC | `이름 [오후 3:30] 메시지` |
| PC (대괄호) | `[이름] [오후 3:30] 메시지` |
| iOS | `2025. 11. 9. 22:07, 이름 : 메시지` |
| 모바일 (한글 날짜) | `2025년 4월 19일 오전 12:41, 이름 : 메시지` |
...
**개선 사항**:
- **Android/PC/iOS/모바일** 카카오톡 내보내기 형식 모두 지원
...
# iOS 형식
2025. 11. 9. 22:07, 이름 : 메시지 내용

# 모바일 형식 (한글 날짜, v2.2 추가)
2025년 4월 19일 오전 12:41, 이름 : 메시지 내용
```
...
- [ ] 특정 시간에 메시지 전송 예약
- [ ] 타이밍 추천과 연동하여 자동 예약
- [ ] "읽씹 후 N시간 뒤 자동 후속 메시지" 설정

#### 3. 대화 시뮬레이터
- [ ] 실제 대화 전 연습 모드
- [ ] AI가 상대방 역할을 하며 대화 연습
- [ ] 면접/고백/사과 등 상황별 연습
